...
saveRDS(iWAT_Seuratobject_updated,"raw_data/iWAT_Seuratobject_ct.updated.rds")
...
saveRDS(eWAT_Seuratobject_updated,"raw_data/eWAT_Seuratobject_ct.updated.rds")
...
source("script/WrapperFunction_utils.r") 
